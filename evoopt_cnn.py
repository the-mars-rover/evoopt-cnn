...
def _evaluate(individual, model, x_train, y_train, x_test, y_test, batch_size, epochs):
...
def _register_evaluate(model, x_train, y_train, x_test, y_test, batch_size, epochs):
    toolbox.register("evaluate", _evaluate, model=model, x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test,
