...
if __name__ == '__main__':
    ...
    print('EvoOpt Experiment >>> getting the appropriate NN architecture model.')
    ...
    file = open(args.results_path + "/" + args.seed + '.log', 'wb')
    pickle.dump(log, file)
    file.close()
    file = open(args.results_path + "/" + args.seed + '.hof', 'wb')
